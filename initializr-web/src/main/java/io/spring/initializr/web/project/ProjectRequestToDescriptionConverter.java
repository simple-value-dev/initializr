...
public class ProjectRequestToDescriptionConverter {
	...
	public ProjectDescription convert(ProjectRequest request,
		...
		description.setDatabaseName(determineValue(request.getDatabaseName(),
				() -> metadata.getDatabaseName().getContent()));
		description.setBuildServerIp(determineValue(request.getBuildServerIp(),
				() -> metadata.getBuildServerIp().getContent()));
		...
		description.setAddServerProject(request.getAddServerProject());
		description.setDatabaseSQLFile(request.getDatabaseSQLFile());
		description
				.setDatabaseDefaultValueSQLFile(request.getDatabaseDefaultValueSQLFile());
