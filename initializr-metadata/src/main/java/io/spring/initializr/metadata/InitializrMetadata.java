...
public class InitializrMetadata {
	...
	private final TextCapability databaseName = new TextCapability("databaseName",
			"Database Name", "database name");

	private final TextCapability buildServerIp = new TextCapability("buildServerIp",
			"Build Server IP", "build server IP");
	...
	private final BooleanCapability addServerProject = new BooleanCapability(
			"addServerProject", "Add server project", "");
	...
	private final TextCapability databaseDefaultValueSQLFile = new TextCapability(
			"databaseDefaultValueSQLFile", "Upload database default values sql file", "");
	...
	public TextCapability getDatabaseName() {
		return this.databaseName;
	}

	public TextCapability getBuildServerIp() {
	...
	public void merge(InitializrMetadata other) {
		...
		this.databaseName.merge(other.databaseName);
		this.buildServerIp.merge(other.buildServerIp);
	...
	public Map<String, Object> defaults() {
		...
		defaults.put("databaseName", this.databaseName.getContent());
		defaults.put("buildServerIp", this.buildServerIp.getContent());
		...
		defaults.put("addServerProject", this.addServerProject.getContent());
		...
		defaults.put("databaseDefaultValueSQLFile",
				this.databaseDefaultValueSQLFile.getContent());
		return defaults;
	}
	...
	public BooleanCapability getAddServerProject() {
	...
	public TextCapability getDatabaseDefaultValueSQLFile() {
