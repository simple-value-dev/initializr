...
public class InitializrProperties extends InitializrConfiguration {
	 ...
	 */
	@JsonIgnore
	private final SimpleElement databaseName = new SimpleElement("NO-DATABASE");

	/**
	 * build server IP metadata.
	 */
	@JsonIgnore
	private final SimpleElement buildServerIp = new SimpleElement("192.168.5.12");
	...
	public SimpleElement getDatabaseName() {
		return this.databaseName;
	}

	public SimpleElement getBuildServerIp() {
